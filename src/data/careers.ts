// Careers 页文案 — 唯一来源 docs/content/requirements-v0.2.md「Careers」节
export const careers = {
  head: {
    eyebrow: 'Careers at Arclink',
    heading: 'Build the future of real-world execution.',
    description:
    ...
    principles: [
      {
        ...
        description: 'Our team works remotely across borders and time zones, with clear communication and trust.',
      },
      {
      ...
      {
        title: 'Ownership and results',
        description: 'We empower people to make decisions, and we focus on outcomes, not activity.',
      },
    ],
  },
  openRoles: {
    ...
    roles: [
      {
        title: 'Global Business Development & Partnerships Manager',
